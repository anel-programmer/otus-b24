...
// $filter массив параметров для выборки из модели ORM
$filter = [];
...
// $ui_filter массив названий полей, по которым будет фильтрация в окне фильтра main.ui.filter
$ui_filter = [
...
// $columns массив названий полей, которые будут выводиться в таблице main.ui.grid
$columns = [];
...
// $list массив записей из ORM модели, которые будут выводиться в таблице main.ui.grid
$list = [];
...
// классы для работы с кнопками таблицы main.ui.grid
