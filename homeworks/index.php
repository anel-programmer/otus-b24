...
?>
    ...
    <section class="container-fluid">
        ...
        <div class="mb-3">Репозиторий: <a href="https://github.com/anel-programmer/otus-b24">https://github.com/anel-programmer/otus-b24</a> </div>
        <ul class="item-list">
            <li>
                <h2 class="item done">
            ...
            <li>
                <h2 class="item fire"><a href="homework6/">ДЗ #6: Написание своего модуля</a>
                    <i class="icon"></i>
                </h2>
            </li>
            <li>
